...
const analysisOfRequirements = `what problems does this project need to solve / features does this need to have `
const design = `how are things going to be organized and look for the user`
const implementation = `build the product`
const testingIntegration = `try to break the product, fix those things, and add new things if needed`
const maintain = `keep the product updated as technology changes. also includes adding new features to keep product relavant`